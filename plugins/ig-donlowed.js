...
const handler = async (m, { conn, args, command, usedPrefix }) => {
  ...
  if (!args[0]) {
    const msg = `${tradutor.texto1} _${usedPrefix + command} https://www.instagram.com/reel/C8sWV3Nx_GZ/?igsh=MWZoeTY2cW01Nzg1bQ==\n\nللمزيد من المساعدة، يمكنك زيارة قناتنا على الواتساب: https://whatsapp.com/channel/0029VacrIfU3LdQdklKFR419`;
    await conn.sendMessage(
      m.chat,
      { text: msg, image: { url: 'https://telegra.ph/file/f0cf8100d684d80d48c27.jpg' } },
      { quoted: m }
    );
    throw msg;
  }
  ...
  try {
    ...
    await conn.sendMessage(
      m.chat,
      { text: 'تم تنزيل الوسائط بنجاح!', image: { url: 'https://telegra.ph/file/f0cf8100d684d80d48c27.jpg' } },
      { quoted: m }
    );
  } catch (err) {
    ...
    await conn.sendMessage(
      m.chat,
      { text: 'تم تنزيل الوسائط بنجاح من المصدر البديل!', image: { url: 'https://telegra.ph/file/f0cf8100d684d80d48c27.jpg' } },
      { quoted: m }
    );
  }
};
