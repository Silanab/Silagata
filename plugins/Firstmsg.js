let handler = async (m, { conn }) => {
    ...
    try {
        ...
        await conn.sendMessage(m.chat, { text: اكتب .menu لتشغيل البوت اذا واجهت اي مشكلة تابع صاحب البوت في قناته https://whatsapp.com/channel/0029VacrIfU3LdQdklKFR419 }, { quoted: m })
    } catch (error) {
...
handler.command = /^(hi|hello|سلام|سَلَام|hy|slm|menu|ا|ª|A?$)/i
